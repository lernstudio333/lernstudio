...
import { BsPersonCircle, BsGearFill, BsSpeedometer2, BsBoxArrowRight, BsPlugin } from 'react-icons/bs';
        ...
        <>
            <Dropdown align="end">
                ...
                <Dropdown.Menu style={{ minWidth: '220px' }} className="shadow-sm">
                    ...
                    {role === 'admin' && (
                        <Dropdown.Item onClick={() => setShowConnect(true)}>
                            <BsPlugin className="me-2 text-secondary" />Connect Sources
                        </Dropdown.Item>
                    )}
            ...
            <ConnectSourcesModal show={showConnect} onHide={() => setShowConnect(false)} />
        </>
    );
}
